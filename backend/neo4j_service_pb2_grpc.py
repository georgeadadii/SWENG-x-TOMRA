...
class Neo4jService(object):
    ...
    def StoreResult(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Neo4jService/StoreResult',
    ...
    def GetFeedback(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Neo4jService/GetFeedback',
